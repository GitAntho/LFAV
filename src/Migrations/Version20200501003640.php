 ...
 */
final class Version20200501003640 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad ADD user_id INT NOT NULL, ADD category VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad DROP user_id, DROP category');
    }
}
